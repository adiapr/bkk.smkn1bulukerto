...
<footer>
   ...
   <a href="#" class="scrollup"> <i class="fa fa-chevron-up"> </i> </a>
    ...
    <!--Plugins-->
	<script type="text/javascript" src="../frontstyle/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="../frontstyle/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="../frontstyle/js/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="../frontstyle/js/jquery.flexslider-min.js"></script>
    <script type="text/javascript" src="../frontstyle/js/jquery.magnific-popup.min.js"></script>
    <script type="text/javascript" src="../frontstyle/js/easing.js"></script>
    <script type="text/javascript" src="../frontstyle/js/jquery.easypiechart.js"></script>
    <script type="text/javascript" src="../frontstyle/js/jquery.appear.js"></script>
