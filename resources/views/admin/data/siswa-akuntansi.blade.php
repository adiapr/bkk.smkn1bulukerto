    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.siswa-ak.add') }}" method="POST">
                @csrf
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text input-group-text-sm" id="basic-addon3">AK -</span>
                                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" style="float: left">List siswa Akuntansi</h4>
            </div>
            <div class="card-body">
                <div>
                    {{-- menampilkam alert --}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div style="width: 90px"></div>
                                    ...
                                    <form action="{{ route('admin.deleteAK', $isi->id) }}" method="post">
                                        @csrf
                                    ...
                                    <div id="myModal{{ $isi->id }}" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <form action="{{ route('admin.updateAK', $isi->id) }}"  method="post">
                                                @csrf
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="hp"value="<?php echo $data['telp'] ?>">
                                                        </div>
                                                    </div>
